...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_jis(
		...
		KC_TAB,   KC_Q,   KC_W,    KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,    KC_P,    JP_AT,   JP_LBRC,          KC_PSCR, KC_PGUP,
		JP_EISU,  KC_A,   KC_S,    KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,    JP_SCLN, JP_COLN, JP_RBRC, KC_ENT,  KC_DEL,  KC_PGDN,
		KC_LSFT,          KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, KC_RSFT, KC_UP, 
		KC_LCTL, KC_LGUI, KC_LALT, JP_MHEN,                KC_SPC,                 JP_HENK, JP_KANA, KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
